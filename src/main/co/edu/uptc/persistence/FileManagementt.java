...
public class FileManagementt {
    ...
    public void writerFile(List<?> datos, String nombreArchivo, String ruta) {
    ...
    public <T> List<T> readFile(Class<T> claseObjeto) {
        ...
        try (BufferedReader br = new BufferedReader(new FileReader(rutaArchivo))) {
            ...
            // StringBuilder para construir el JSON completo a partir de las líneas del
            // archivo
            ...
            // Convertir el StringBuilder a una cadena y eliminar los espacios en blanco al
            // principio y al final
            String json = jsonBuilder.toString().trim();

            // Verificar si el JSON comienza y termina con "{}" para determinar si es un
            // objeto JSON
            if (json.startsWith("{") && json.endsWith("}")) {
                ...
                // Si el JSON no es ni un objeto ni un array válido, imprimir un mensaje de
                // advertencia
